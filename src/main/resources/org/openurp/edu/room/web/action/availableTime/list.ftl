...
[@b.grid items=availableTimes var="availableTime"]
  ...
  [@b.row]
    ...
    [@b.col width="20%" title="日期"]${availableTime.time.weekday}&nbsp;&nbsp;${availableTime.time.firstDay?string("yy/MM/dd")}~${availableTime.time.lastDay?string("yy/MM/dd")}[/@]
    [@b.col width="10%" title="时间"]${availableTime.time.beginAt}-${availableTime.time.endAt}[/@]
  [/@]
  [/@]
